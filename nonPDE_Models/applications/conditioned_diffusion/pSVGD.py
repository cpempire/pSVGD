...
options["rank_Hessian"] = np.min([options["number_particles"]*comm.Get_size(), 100])
options["rank_Hessian_tol"] = 1.e-1
options["low_rank_Hessian_average"] = True
options["rank_Hessian_average"] = np.min([options["number_particles"]*comm.Get_size(), 100])

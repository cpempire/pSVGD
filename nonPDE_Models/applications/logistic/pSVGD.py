...
options["rank_Hessian"] = np.min([options["number_particles"]*comm.Get_size(), 128])
options["rank_Hessian_tol"] = 1.e-2
options["low_rank_Hessian_average"] = True
options["rank_Hessian_average"] = np.min([options["number_particles"]*comm.Get_size(), 128])
...
filename = "load_data/mcmc_dili_sample.p"
